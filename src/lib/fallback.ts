  ...
  item: [
    {
      ...
      type: "Espada",
      rarity: "Legendaria",
      appearance: "Espada de acero lunar con filo negro que absorbe la luz, incrustada con cristales de sombra que susurran al portador",
    ...
    },
    {
      ...
      type: "Amuleto",
      rarity: "Rara",
      appearance: "Moneda antigua con el perfil de un dios sonriente en una cara y una balanza en la otra, siempre cálida al tacto",
    ...
    },
    {
      ...
      rarity: "Épica",
      appearance: "Capa de seda eléctrica que chisporrotea levemente, deja un rastro de estática en el aire al moverse",
  ...
  lore: [
    {
      ...
      history: "Conflicto centenario entre el Trono de Brasa y el Consejo del Velo que partió el continente en siete fragmentos, exterminó dos razas completas y cerró para siempre las Puertas del Amanecer",
    ...
    },
    {
      ...
      history: "Astrónomos de la antigua academia descubrieron que las estrellas no son luz sino agujeros en la realidad a través de los cuales algo observa, estudia y espera pacientemente a sus presas",
  ...
  enemy: [
    {
      ...
      appearance: "Predador de seis patas con piel camaleónica y tendones como cables de acero; sus ojos reflejan el miedo de las presas",
    ...
    },
    {
      ...
      appearance: "General caído resucitado por ritos prohibidos, aún viste su armadura destrozada y recuerda fragmentos de su vida mortal",
    ...
    },
    {
      ...
      appearance: "Señor de los Planos de las Cenizas, un coloso de obsidiana y lava que desprende calor suficiente para derretir armaduras de acero",
